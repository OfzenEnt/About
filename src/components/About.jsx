...
function AboutUs() {
    return (
        <>
            <NavBar />
            <div className="bg-gray-50 lg:w-full  lg:p-1  py-10 items-center">
                ...
                <section className="flex flex-col lg:flex-row justify-between items-center gap-12 lg:gap-24">
                    ...
                    <div className="w-full lg:w-1/2 flex justify-center">
                        <img
                            ...
                            className="rounded-xl w-full max-w-sm lg:max-w-[500px] lg:h-[390px] object-contain"
                        />
                    </div>
                    ...
                    <div className="w-full lg:w-1/2 flex flex-col justify-center mt-4">
                        ...
                        <p className="italic text-gray-700 lg:mb-6 text-justify lg:mr-32 lg:ml-0 mr-10 ml-10">
                        ...
                        <div className="flex items-center gap-4 m-10">
                            <img
                                ...
                                className="rounded-full w-[80px] h-[80px] object-cover shadow-lg shadow-gray-300 border-2 border-white"
                            />
                            <div>
