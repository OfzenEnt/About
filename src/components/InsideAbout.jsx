                ...
                <section className="grid lg:grid-cols-4 gap-8 p-10 ">
                    <div className="col-span-2 grid grid-cols-2 gap-4 overflow-hidden">
                        ...
                        <div >
                            ...
                            <div className="col-span-2 grid grid-cols-2 gap-4 space-y-3 lg:mt-8 mt-6 lg:p-1">
                ...
                <section className="p-12 bg-gray-50 text-left w-full overflow-hidden">
                    ...
                    <div className="grid lg:grid-cols-3 gap-20">
                        <div className="space-y-6 col-span-2">
                            ...
                            <div className="bg-blue-50 lg:p-3 p-2 rounded-lg shadow-lg lg:mr-20 flex items-center">
                            ...
                            <div className="bg-blue-50 p-3 rounded-lg shadow-lg lg:ml-20 flex items-center">
                            ...
                            <div className="bg-blue-50 p-3 rounded-lg shadow-lg lg:mr-20 flex items-center">
                                ...
                                <div>
                                    ...
                                    <ul className="list-disc list-inside lg:grid-cols-5 grid grid-cols-2 text-left ml-3 gap-2 lg:text-base">
                                        <li>
                                            Innovation
                                        </li>
                                        <li>Integrity </li>
                        ...
                        <img src={"src/assets/team4.jpg"} className="rounded-lg lg:w-auto lg:h-[450px]  w-72 h-96 ml-11  hidden lg:block" />
                    </div>
                </section >
                    ...
                    <div className="grid grid-cols-2 lg:grid-cols-3 gap-4 ">
                        {teamMembers.map((member, i) => (
                            <div key={i} className=" bg-white rounded-lg shadow p-2 flex lg:flex-row lg:text-left lg:space-x-4 flex-col">
                                <img src={member.img} className="w-16 h-14 rounded-full lg:w-36 lg:h-36 lg:rounded-lg lg:float-start lg:ml-0 lg:mt-0 lg:mx-0 mx-auto mt-2" />
                                <div>
