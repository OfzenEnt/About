    ...
    return (
        <>
            ...
            <div className="text-gray-800 font-sans max-w-screen mx-auto">
                ...
                <section className="grid lg:grid-cols-4 gap-8 p-10 max-w-screen lg:max-h-[449]  overflow-hidden">
                    <div className="col-span-2 grid grid-cols-2 gap-4 row-span-2 ">
                        <img src={"/Twopersons.jpg"} className="rounded-lg w-full lg:h-[450px] md:h-[575px] px-2 lg:p-0 md:p-0" />
                        <div className="">
                            <img src={"/tablesitting.jpg"} className="rounded-lg w-full h-auto object-cover max-h-[295px]  mb-7" />
                            <div className="col-span-2 grid grid-cols-2 gap-4 space-y-3  "> {/*  lg:mt-8 mt-6 lg:p-1 */}
                                <img src={"/woman.jpg"} className="rounded-lg max-w-screen" />{/* rounded-lg w-40 h-32 md:w-48 md:h-40 lg:w-72 lg:h-72 object-cover*/}
                                <div className="bg-blue-600 text-white text-center flex items-center justify-center lg:text-xl md:text-xl text-xs font-semibold rounded-lg ">25+<br />Years of Experience</div>
                ...
                <section className="px-12 py-19 bg-gray-50 text-left w-full">
                    ...
                    <div className="grid lg:grid-cols-3 gap-20">
                        <div className="space-y-6 col-span-2">
                            ...
                            <div className="bg-blue-50 p-3 rounded-lg shadow-lg lg:mr-20 flex items-center">
                                ...
                                <div>
                                    ...
                                    <ul className="list-disc list-inside lg:grid-cols-5 md:grid-cols-5 grid grid-cols-2 text-left ml-3 gap-2 lg:text-base">
                                        <li>
                                            Innovation
                                        </li>
                                        <li>Integrity </li>
                        ...
                        <img src={"/blackshirt.jpg"} className="rounded-lg lg:w-auto lg:h-[450px]  w-72 h-96 ml-11  hidden lg:block" />
                    </div>
                </section >
                ...
                <section className="p-12 w-full overflow-hidden">
                    ...
                    <div className="flex flex-col lg:flex-row items-center gap-8 ">
                        <img src={"/fiveperson.jpg"} className="lg:p-6 p-1 lg:w-1/3 rounded-lg" />
                ...
                <section className="p-12 grid lg:grid-cols-2 gap-8">
                    <div className="bg-blue-100 p-6 lg:rounded-bl-[90px] rounded-lg overflow-hidden">
                        ...
                        <p className="mt-4 text-justify">Glarimy symbolizes our technology vertical a young, agile, and curious mind constantly exploring new possibilities. She represents our approach to solving modern business problems through SaaS, mobile apps, consulting, and upskilling programs.
                    ...
                    <div className="grid grid-cols-2 lg:grid-cols-3 gap-4 ">
                        {teamMembers.map((member, i) => (
                            <div key={i} className=" bg-white rounded-lg shadow p-2 flex lg:flex-row lg:text-left lg:space-x-4 flex-col">
                                <img src={member.img} className="w-16 h-16 lg:w-36 lg:h-36 lg:rounded-lg md:w-36 md:h-36 md:rounded-lg rounded-full  mx-auto mt-2 object-cover  lg:m-0 " />{/* lg:w-36 lg:h-36 lg:rounded-lg lg:float-start lg:ml-0 lg:mt-0 lg:mx-0 */}
                                <div>
