...
function AboutUsPage() {
    const teamMembers = [
        ...
        { name: "Keira Battye", role: "Product Designer", img: "src/assets/team3.jpg" },
        { name: "Dominic Game", role: "3D Artist", img: "src/assets/team4.jpg" },
        { name: "James Vial", role: "Head of Front-End", img: "src/assets/team3.jpg" }
    ]
    return (
        <div className="text-gray-800 font-sans">
            <header className="h-[150px] lg:h-[300px] bg-cover bg-center flex items-center justify-center " style={{ backgroundImage: `url(${"src/assets/team2.jpg"})`, opacity: 0.6 }}>
            ...
            <section className="grid lg:grid-cols-4 gap-8 p-10 ">
                <div className="col-span-2 grid grid-cols-2 gap-4 overflow-hidden">
                    ...
                    <div >
                        ...
                        <div className="col-span-2 grid grid-cols-2 gap-4 space-y-3 mt-10 lg:p-1 ">
                            <img src={"src/assets/team3.jpg"} className="rounded-lg w-48 h-40 lg:w-72 lg:h-72 sm:w-40 sm:h-32" />
                            <div className="bg-blue-600 text-white text-center flex items-center justify-center lg:text-xl text-xs font-semibold rounded-lg ">25+<br />Years of Experience</div>

                        </div>
                    </div>
                </div>
                <div className="col-span-2 bg-blue-100 lg:p-6 p-4 rounded-lg  w-full lg:space-y-6 lg:text-lg text-sm">
                    <h3 className="text-blue-800 font-serif mb-2 text-left lg:text-3xl text-xl lg:mt-7 mt-3">ABOUT KOYYA</h3>
                    <h2 className=" font-mono text-400 lg:mb-4 mb:3 text-left lg:text-4xl text-2xl">Digitally rooted.<br /> Naturally driven.That’s<br /> the Koyya way.</h2>
            ...
            <section className="p-10 bg-gray-50 text-left w-full overflow-hidden">
                <h2 className="lg:text-4xl text-3xl font-bold mb-4 lg:w-1/2 text-blue-600 text-left">Empowering Progress: Bridging Agriculture and Technology for a Better Tomorrow</h2>

                <div className="grid lg:grid-cols-2 gap-20">
                    <div className="space-y-6 ">
                        <p className="text-xl mb-8 text-gray-600 max-w-2xl">Bridging agriculture and technology to create impactful, sustainable solutions that shape a brighter tomorrow.</p>
                        <div className="bg-blue-50 lg:p-3 p-2 rounded-lg shadow-lg lg:mr-12 flex items-center">
                            <img src={"src/assets/missionimg.png"} className="lg:w-16 lg:h-16 w-12 h-12 mr-2 mt-3" alt="Mission Icon" />
                            <div>
                                <h3 className="text-blue-700 font-semibold lg:mb-2 lg:text-xl ml-3">Mission</h3>
                        ...
                        <div className="bg-blue-50 p-3 rounded-lg shadow-lg lg:ml-12 flex items-center">
                            <img src={"src/assets/visionimg.png"} className="lg:w-16 lg:h-16 w-12 h-12 mr-2 mt-3" alt="Vision Icon" />
                            <div>
                                <h3 className="text-blue-700 font-semibold lg:mb-2 lg:text-xl ml-3">Vision</h3>
                                <p className="flex items-center ml-3 text-sm text-justify">To be a leading force in bridging the gap between agribusiness and technology, creating a future where digital innovation uplifts rural roots and modern enterprises alike.</p>
                            </div>
                        </div>
                        <div className="bg-blue-50 p-3 rounded-lg shadow-lg lg:mr-12 flex items-center">
                            <img src={"src/assets/coreimg.png"} className="lg:w-16 lg:h-16 w-12 h-12 mr-2 mt-3" alt="Mission Icon" />
                            <div>
                                <h3 className="text-blue-700 font-semibold lg:mb-2 ml-3 lg:text-xl">Core Values</h3>

                                <ul className="list-disc list-inside lg:grid-cols-3 lg:grid  text-left ml-3 flex gap-2">
                                    <li>
                                        Innovation
                                    </li>
                                    <li>Integrity </li>
                                ...
                                <ul className="list-disc list-inside lg:grid-cols- grid-cols-2 grid text-left ml-3">
                                    <li>Excellence </li>
                                    <li>Collaboration</li>
                                </ul>
                            </div>
                    ...
                    <img src={"src/assets/team4.jpg"} className="rounded-lg lg:w-2/4 lg:h-[570px]  w-72 h-96 ml-11  " />
                </div>
            </section >
            ...
            <section className="p-12 w-full overflow-hidden">
                ...
                <div className="flex flex-col lg:flex-row items-center gap-8 ">
                    <img src={"src/assets/team5.jpg"} className="lg:p-6 p-1 lg:w-1/3 rounded-lg" />
            ...
            <section className="lg:p-10 p-5 bg-blue-50 mb-4 ml-11 mr-11 rounded-lg ">
                ...
                <div className="grid grid-cols-2 lg:grid-cols-3 gap-4 ">
                    {teamMembers.map((member, i) => (
                        <div key={i} className=" bg-white rounded-lg shadow p-2 flex lg:flex-row lg:text-left lg:space-x-4 flex-col">
                            <img src={member.img} className="w-16 h-14 rounded-full lg:w-36 lg:h-36 lg:rounded-lg lg:float-start lg:ml-0 ml-8" />
                            <div>
